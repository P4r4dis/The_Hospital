...
////////AddSick
        ...
        cr_assert(bellevue.getSickKoalaList()->getPatient()->get_name() == "Scarface");
        bellevue.addSick(&sick3);
        cr_assert(bellevue.getSickKoalaList()->getPatient()->get_name() == "RedFace");
        bellevue.addSick(&sick4);
        cr_assert(bellevue.getSickKoalaList()->getPatient()->get_name() == "Varia");
        bellevue.addSick(&sick5);
        cr_assert(bellevue.getSickKoalaList()->getPatient()->get_name() == "Falter");
...
////////AddNurse
        ...
        cr_assert(bellevue.getKoalaNurseList()->getNurse()->getID() == 2);
